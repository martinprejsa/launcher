...
func (a *Bridge) GetProfileInformation() ProfileInfo {
	return ProfileInfo{
		"WattMann", "https://static.remove.bg/remove-bg-web/ea4eaf12fdb825d09a927ec03bfcfc723af95931/assets/start-1abfb4fe2980eabfbbaaa4365a0692539f7cd2725f324f904565a9a744f8e214.jpg",
	}
}

func (a *Bridge) Authenticate() bool {
	_, _ = api.MSGetAccessToken()
	return false
}
